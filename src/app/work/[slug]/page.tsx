    ...
    <div className="site-shell bg-black min-h-screen text-black overflow-x-hidden">
      ...
      >
        ...
        <main className="pt-[clamp(80px,10vw,120px)] px-[10px] pb-[10px]">
          ...
          {/* HERO SECTION */}
          <section 
            className="relative border-2 border-black rounded-t-[clamp(4px,0.8vw,8px)] p-[5vw] overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <h1 className="m-0 font-[family-name:var(--font-alumni)] text-[clamp(60px,10vw,180px)] font-bold leading-[0.85] uppercase tracking-tight max-w-[1500px]">
                  {data.title}
                </h1>
                <p className="mt-8 text-[clamp(18px,2vw,28px)] font-medium max-w-3xl leading-[1.3] font-[family-name:var(--font-inter)] border-l-4 border-black pl-6">
                  {data.description}
                </p>
              </motion.div>
            </div>

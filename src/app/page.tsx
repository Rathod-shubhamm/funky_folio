...
const services = [
  {
    ...
    date: "11-20-23",
    title: "RAG Systems",
    skills: ["Vector DBs", "Embeddings", "LlamaIndex", "LangChain", "Retrieval", "Chunking"],
    route: ["VEC", "EMB", "QNA"],
    color: "#f04d3c",
  },
  {
    ...
    date: "03-20-24",
    title: "AI Agents",
    skills: ["Autogen", "CrewAI", "Tool Use", "Reasoning", "n8n", "Workflows"],
    route: ["AUT", "LOG", "ACT"],
    color: "#ffae00",
  },
  {
  ...
  },
  {
    ...
    skills: ["Airflow", "Spark", "Kafka", "Data Cleaning", "SQL", "Scraping"],
    route: ["EXT", "TRF", "LOD"],
    color: "#b83e85",
  },
  {
    ...
    skills: ["Architecture", "Docker", "CI/CD", "AWS/GCP", "Security", "Pre-Sales"],
    route: ["B2B", "ARC", "DEL"],
    color: "#d4cbb8",
  },
];
    ...
    <div className="site-shell">
      ...
      <header className="site-header">
        ...
        <nav className="site-nav" aria-label="Main navigation">
          ...
          <a href="https://drive.google.com/file/d/17De1K-upPAE7M0uE8Q8ixuyyaNDv5PPr/view?usp=sharing" target="_blank" rel="noopener noreferrer">
            <span>Resume</span>
